...
ACTIONS = [
 ...
 ('actFindCurrent',    'Find Word at &Cursor',  sc('ctrl','F3'), 'actFindCurrentExecute', ''),
 ('actFindCurrentBack','Find Word at Cursor &Backwards', sc('ctrl','shift','F3'), 'actFindCurrentBackExecute', ''),
